...
* `-DBESPOKE_VST2_SDK_LOCATION=/path/to/sdk` will activate VST2 hosting support in your build 
...
* `-DBESPOKE_PYTHON_SUPPORT=false` will disable Python live scripting support in your build
